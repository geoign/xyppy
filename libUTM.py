...
#Call example: #23=WGS84
# Zone, Easting, Northing = libUTM.LLtoUTM(23, Lat, Lon)
# Lat Lon = libUTM.UTM2LL(23, Easting, Northing, Zone) 
...
if __name__ == '__main__':
    ...
    #print LLtoUTM(23, -31.1, -179)
    #print LLtoUTM(23, -31.2, -179.04)
    #print LLtoUTM(23, 31, 130.75)
    #print UTMtoLL(23,-69183,-245906.4,"53S")
    if(len(sys.argv) == 4): print LLtoUTM(sys.argv[1],sys.argv[2],sys.argv[3])
    elif(len(sys.argv)==5): print UTMtoLL(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4])
